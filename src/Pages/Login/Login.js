...
import { axios_, extractData, updateFormData, validateForm } from "../../utilities/utll";
...
export default function Login() {
	...
	return (
		<div className='loginPage'>
			{message && <Toast unloader={setMessage} message={message} success={success} />}
			<div className='logo'>
			...
			<div className='loginform'>
				...
				<FormGenerator formData={formData} functions={functions} componentType={"login"} />
			</div>
			<div className='footer'>
				<div className='contact'>
					<span>
						<IoMdMail />
						<a href='mailto:Support@nandiniinfosys.com'>Support@nandiniinfosys.com</a>
					</span>
					<span>
						<IoIosCall />
